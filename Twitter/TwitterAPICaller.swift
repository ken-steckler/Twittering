...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "nb6Hl7WIJbnTarjsM4Iu8H3Wg", consumerSecret: "dE2BHAC6xvsTYIHvEzbgfPsnLIrxxBH4akgZLWdgYJ06nTLHCR")
    var loginSuccess: (() -> ())?
